...
describe("battery analysis", () => {
	it("contains the documented capacities", () => {
		expect(getBatteryModel("home-5.8")).to.include({ nominalCapacityKwh: 5.76, usableCapacityKwh: 5.2 });
		expect(getBatteryModel("home-plus-7.7")).to.include({ nominalCapacityKwh: 7.68, usableCapacityKwh: 7 });
	});
