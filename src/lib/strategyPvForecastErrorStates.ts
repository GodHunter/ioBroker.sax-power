import type { StrategyPvForecastErrorStatus } from "./strategyPvForecastErrorLearning";

export const STRATEGY_PV_FORECAST_ERROR_STATE_IDS = Object.freeze({
...
export interface StrategyPvForecastErrorPublication extends StrategyPvForecastErrorStatus {
	readonly lastUpdate: number;
	readonly modelSnapshot: string;
}

export interface StrategyPvForecastErrorIoBrokerAdapter {
...
export async function ensureStrategyPvForecastErrorStates(adapter: StrategyPvForecastErrorIoBrokerAdapter): Promise<void> {
...
export async function publishStrategyPvForecastError(adapter: StrategyPvForecastErrorIoBrokerAdapter, publication: StrategyPvForecastErrorPublication): Promise<void> {
	await Promise.all([
